...
namespace Quizly.Views
{
    public partial class BottomNavBar : UserControl
    {
        ...
        private void Friends_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            _main?.GoFriends();
        }

        private void Locked_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            // nur Demo – später echte Views
        }
    }
}
